     ...
     <>
        <div className="flex flex-col p-5 md:p-20">
            ...
            <div>
                ...
                <option value="others">Hybrid</option>
                <option value="all">All</option>
                </select>

                <select class="px-4 py-3 w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm">
                <option value="">Course Duration</option>
                <option value="week">1-3 Week</option>
                <option value="onesixmonth">1-6 Months</option>
                <option value="onetwelvemont">1-12 Months</option>
            ...
            <div className="mt-20">
                ...
                <main>
                    <ul className='container flex flex-wrap justify-center w-full'>
                        {courses.map(e => (

                        <li className='m-4' key={e.id}>
                        <CourseCard 
                            id = {e.id}
                            title = {e.title}
                        />
